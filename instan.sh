...
#https://github.com/bohemianskode/instan.git
...
printf " \n"
	...
	echo -e $'\e[1;33m\e[0m\e[1;37m            "#          ~INSTAN~             #" \e[0m'
	echo -e $'\e[1;33m\e[0m\e[1;37m            "#################################" \e[0m'
	echo -e $'\e[1;33m\e[0m\e[1;37m            "#       ~BOHEMIA-VICKY~         #" \e[0m'
	echo -e $'\e[1;33m\e[0m\e[1;37m            "#################################" \e[0m'
    echo ""
    echo -e $'\e[1;33m\e[0m\e[1;33m                 [ \e[0m\e[1;32m Penulis by bohemianskode \e[0m \e[1;32m\e[0m\e[1;33m ] \e[0m'
    echo ""
   
printf " \n"


printf " \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m Masukan Nomor Yang Anda Mau Jalankan Script nya \e[0m\n"
}
...
if [[ $user == "" ]]; then
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Silahkan Login Terlebihdulu\e[0m\n"
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Ketikan Username: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Pengguna Username Ditemukan :\e[0m\e[1;77m %s\e[0m\n" $user
...
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Gunakan kredensial Username/Password yang disimpan\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
read -s -p $'\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Ketikan Password: \e[0m' pass
printf "\n"
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Masuk Kembali Sebagai\e[0m\e[1;93m %s\e[0m\n" $user
IFS=$'\n'
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Menghasilkan daftar gambar\n"
...
count_img=0
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Total Gambar:\e[0m\e[1;93m %s\e[0m \n" $tot_img

for img in $(cat links); do

let count_img++
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Download Gambar\e[0m\e[1;93m %s/%s\e[0m " $count_img $tot_img
wget $img -O $user/images/image$count_img.jpg > /dev/null 2>&1
printf "\e[1;92mDONE!\n\e[0m"
done
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Saved:\e[0m\e[1;93m %s/Gambar/\e[0m\n" $user
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Total Video:\e[0m\e[1;93m %s\e[0m\n" $tot_vid
for link in $(cat vid_$user); do
let count++
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Download video\e[0m\e[1;93m %s/%s\e[0m " $count $tot_vid
printf "\e[1;92mDONE!\n\e[0m"
wget $link -O $user/videos/video$count.mp4 > /dev/null 2>&1
done

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] SIMPAN:\e[0m\e[1;93m %s/videos/\e[0m\n" $user
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m SIMPAN:\e[0m\e[1;77m %s.following_backup\e[0m\n" $user_account
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Sedang Membuat daftar untuk pengguna\e[0m \e[1;77m%s\e[0m\n" $user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Harap tunggu...\e[0m\n"
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m SIMPAN:\e[0m\e[1;77m %s.followers_backup\e[0m\n" $user_account
...
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Akun (kosongkan untuk menggunakan akun Anda): \e[0m' user_account
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Download Story Video\e[0m\e[1;93m %s/%s\e[0m " $count $tot_vid
printf "\e[1;92mDONE!\n\e[0m"
IFS=$'\n'
wget $link -O $user_account/story/story$count.mp4 > /dev/null 2>&1
done

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] SIMPAN:\e[0m\e[1;93m %s/story/\e[0m\n" $user_account

#Story Image
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Total Gambar Stories:\e[0m\e[1;93m %s\e[0m\n" $tot_img

for link2 in $(cat $user_account.story_images); do
let count2++

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] ownloading story gambar\e[0m\e[1;93m %s/%s\e[0m " $count2 $tot_img
printf "\e[1;92mDONE!\n\e[0m"
IFS=$'\n'
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Bersiap untuk berhenti mengikuti dari semua pengikut anda \e[0m\e[1;77m%s ...\e[0m\n" $user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;31m Press \"Ctrl + c\" STOP...\e[0m\n"
sleep 4
while [[ true ]]; do
...
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$user_id'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Sedang Menjalankan Prosess Unfollow %s ..." $unfollow_name
...
if [[ $check_unfollow == "" ]]; then
printf "\n\e[1;93m [!] Error, berhenti untuk mencegah pemblokiran\e[0m\n"
exit 1
else
printf "\e[1;92mOK\e[0m\n"
fi
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Tehnik ini Untuk Meningkatkan Follwers Anda... \e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Selamat Menunggu dan Menikmati Kopi....  \e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m]\e[0m\e[1;93m Press Ctrl + C untuk stop \e[0m\n"
sleep 5
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m%s\e[0m\e[1;31m]\e[0m\e[1;93m Prosess %s ... \r" "$spinstr" $celeb
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Sedang Prosess secs...\e[0m\n"
sleep 100
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Prosess %s ..." $celeb
check_unfollow=$(curl -s -L -b cookie.$user -d "ig_sig_key_version=4&signed_body=$hmac.$data" -s --user-agent 'User-Agent: "Instagram 27.0.0.7.97 Android (24/7.0; 380dpi; 1080x1920; OnePlus; ONEPLUS A3010; OnePlus3T; qcom; en_US)"' -w "\n%{http_code}\n" -H "$header" "https://i.instagram.com/api/v1/friendships/destroy/$celeb/" | grep -o '"following": false' )

if [[ $check_unfollow == "" ]]; then
printf "\n\e[1;93m [!] Kesalahan, berhenti untuk mencegah pemblokiran\n"
exit 2
else
printf "\e[1;92mOK\e[0m\n"
fi
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Sedang Prosess...\e[0m\n"
sleep 60
...
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Akun (biarkan kosong untuk menggunakan akun Anda): \e[0m' user_account

user_account="${user_account:-${default_user}}"

if [[ -e followers1.$user_account ]]; then

printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Daftar terakhir ditemukan untuk pengguna \e[0m\e[1;77m%s\e[0m\e[1;93m, membuat yang baru dan membandingkannya\e[0m\n" $user_account
total_followers
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m idak ada Unfollower\e[0m\n"
fi


else
#get  followers
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Membuat daftar pengikut\e[0m\n"
total_followers
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Silakan, jalankan lagi untuk melacak orang yang berhenti mengikuti\e[0m\n"
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m %s\e[0m\e[1;93m Info Akun:\e[0m\n" $user_account
cat $user_account/profile.info
grep -o 'https://[^ ]*.jpg[^\ ]*.' $user_account/profile.info | cut -d '"' -f1 | tr -d '\\' | uniq > $user_account/profile_pic


printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Download Profil Gambar...\e[0m"
count=0
